Designed for the two .py files to be bound to two keys or mouse buttons and used in real time, like an extended functionality of Clipboard History (WIN+V).
